...
<html>
  ...
  <jsp:include page="../common/navigate.jsp"/>
	...
	<script type="text/javascript" src="../js/LaiviTab.js"></script>
	...
	<script type="text/javascript">
		$(document).ready(laivi.init(function(){
			...
			new LaiviTab({
				parentContainer:'#spaceTabDivId',
				tabs:[
					{name:'个人动态',page:'user_space_1.jsp'},
					{name:'朋友动态',page:'user_space_2.jsp'}
				]
			});
		}));
	</script>
