...
<div class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li><a href="/bbs/bbs.jsp">论坛</a></li>
              <li><a href="/picture/picture.jsp">记忆点滴</a></li>
              <li><a href="/music/music.jsp">音乐天地</a></li>
              <li><a href="/shopping/shopping.jsp">商城</a></li>
              <li class="dropdown">
                <a href="/knowledge/article.jsp" class="dropdown-toggle" data-toggle="dropdown">信息记录 <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="/knowledge/article.jsp">博客</a></li>
                  <li class="divider"></li>
                  <li class="nav-header">知识管理</li>
                  <li><a href="/knowledge/knowledge.jsp">知识</a></li>
                </ul>
              </li>
              <li><a href="/aboutus/aboutus.jsp">关于我们</a></li>
            </ul>
            ...
            <s:else>
            	<div class="nav-collapse collapse">
	            	<ul class="nav pull-right">
	            		<li><a href='/user/user.jsp?id=<s:property value="#session.user.id"/>'><s:property value="#session.user.userName"/></a></li>
    ...
    <div id="backTopDivId" style="display: none; width: 50px; height: 95px; position: fixed;top: 250px; right: 10px; z-index: 100; text-align: center; cursor: pointer;">
    	<p><a onclick="toDir('top')">
    		<img src='/images/back-top.png' alt='返回顶部' title='返回顶部' border='0'>
    	</a></p>
    	<p><a onclick="toDir('before')">
    		<img src='/images/back-before.png' alt='返回前一页' title='返回前一页' border='0'>
    	</a></p>
    	<p><a onclick="toDir('bottom')">
    		<img src='/images/back-bottom.png' alt='返回底部' title='返回底部' border='0'>
    	</a>
    	</p>
    </div>