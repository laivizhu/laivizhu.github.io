...
function contractApproval(){
   ...
   houQian.confirm('确定审批通过？',function(){
		houQian.getJson('frameContract_confirmPass.action?id='+id+'&status='+'20'+getRandParam(),                         function(result){
			  houQian.alert(result.msg);
			  window.location.href = "contract_approval.jsp#0";
			});
		});
}
...
<tbody><tr>
    <td style="padding-left:15px;" nowrap="nowrap">您现在的位置： 合同管理 &gt; 合同审批 &gt; 审批框架合同</td>
...
<td style="width:15%" align="center" nowrap="" class="dvtSelectedCell" id="bi" onclick="fnLoadValues('bi','mi','basicTab','moreTab','normal','Contacts')"><b>审批框架合同</b></td>
