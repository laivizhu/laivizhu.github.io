...
$(document).ready(function(e) {
	var table2 = new HouQianTable({
					url:"frameContract_list.action?status=40",
					parentContainer:"#approvalDiv2",
					columns:[
					...
					specialOperations:[
						{name:"审批",callback:function(data){
						   window.location.href = "contractApproval_modifyView.action?id="+data.id;	
						}},
					],
					pageCount:2,
					selectType:1
...
<div id="approvalDiv2" class="small" style="width:100%;position:relative;"></div>
