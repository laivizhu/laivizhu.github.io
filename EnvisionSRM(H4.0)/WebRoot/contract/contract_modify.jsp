...
<script language="javascript" type="text/javascript">
	$(document).ready(function(e) {
		var table = new HouQianTable({
					url:"frameContract_list.action?status=20",
					...
					specialOperations:[
						{name:"变更",callback:function(data){
						 //  if(houQian.isNotNull(data)){
						      window.location.href = "contractOperate_modifyView.action?id="+data.id;	
						 //  }
						}}
					],
					pageCount:8,
                ...
                <td><table class="small" border="0" cellpadding="3" cellspacing="0" width="100%">
                    <tbody>
                      <tr>
                        ...
                        <td id="test2" class="dvtSelectedCell" align="center" nowrap="nowrap">合同变更</td>
...
<div id="approval_failed_reason" style="display:none">
 <jsp:include page="approval_failed_reason.jsp" flush="true"/>
</div>
<!-- 网站底部 -->
