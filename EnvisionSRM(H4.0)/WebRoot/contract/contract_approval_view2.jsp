...
function contractApproval(){
   ...
   houQian.confirm('确定审批通过？',function(){
		houQian.getJson('frameContract_confirmPass.action?id='+id+'&status='+'20'+getRandParam(),                         function(result){
			  ...
			  window.location.href = "contract_approval.jsp#1";
			});
		});
}
      ...
      <tbody>
        ...
        <tr style="height:25px">
         ...
         <tr style="height:25px">
          ...
          <td align="left" class="dvtCellInfo" id="price">
          V0<s:property value="#request.contractConcent.priceVersion"/></td>
          <td align="left" class="dvtCellInfo" id="price"><s:property value="#request.contractConcent.price"/></td>
