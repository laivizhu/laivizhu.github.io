...
<table width="100%" cellpadding="0" cellspacing="0" class="widgetHandle">
  <tbody><tr>
	<td width="70%" nowrap="nowarp" class="widgetHandleTitle">任务清单</td>
...
<table width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td class="widget_content_title">任务名称</td>
	<td class="widget_content_title" width="60px">剩余时间</td>
  </tr>
  <div id="content">
  <tr>
    <td class="widgetContentDetail"><a href="#" title="">物料小组项目</a></td>
    <td class="widgetContentDetail">1天 </td>
  </tr>
  <tr>
    <td  class="widgetContentDetail"> <a href="#" title="">采购寻源项目</a></td>
    <td  class="widgetContentDetail">0天</td>
  </tr>
  <tr>
    <td class="widgetContentDetail"><a href="#" title="">供应商考核项目</a></td>
    <td class="widgetContentDetail"> 2天</td>
  </tr>
