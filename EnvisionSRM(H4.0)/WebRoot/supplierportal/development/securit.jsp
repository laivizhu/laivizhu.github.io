...
<table border="0" cellpadding="0" width="100%" class="level2Bg">
  <tbody>
    <tr>
      ...
      <td class="level2UnSelTab" nowrap="nowrap"><a href="supplier_in.jsp">供应年度评估输入</a> </td>
      <td class="level2UnSelTab" nowrap="nowrap"><a href="supplier_out.jsp">供应年度评估结果</a> </td>
      <td class="level2UnSelTab" nowrap="nowrap"><a href="complaintList.action">投诉</a> </td>
      <td class="level2UnSelTab" nowrap="nowrap"><a href="advice_list.jsp">合理化建议</a> </td>
      <td width="100%">&nbsp;</td>
    </tr>
  </tbody>
</table>
                ...
                <td><table class="small" border="0" cellpadding="3" cellspacing="0" width="100%">
                    <tbody>
                      <tr>
                        ...
                        <td id="test1" class="dvtSelectedCell" align="center" nowrap="nowrap" onclick="DispContent(1,2);">查看保密协议</td>
                        <td class="dvtTabCache" style="width: 10px;" nowrap="nowrap">&nbsp;</td>
                        <td id="test2" class="dvtUnSelectedCell" align="center" nowrap="nowrap" onclick="DispContent(2,2);">上传保密协议</td>
                            ...
                            <tbody>
                              <tr>
                                <td style="padding: 10px;">
                                  <jsp:include page="securit_1.jsp" flush="true"/>
                                  <jsp:include page="securit_2.jsp" flush="true"/>
                                </td>
                              </tr>
                            </tbody>
                          </table></td>
