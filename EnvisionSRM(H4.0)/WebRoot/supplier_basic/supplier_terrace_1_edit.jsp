                                                ...
                                                <tbody>
                                                  <tr style="height:25px">
                                                    <td ><table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                        <tbody>
                                                          <tr>
                                                            <td colspan="4" class="detailedViewHeader"><b>编辑质量管理事件</b></td>
                                                          </tr>
                                                          
                                                          <tr style="height:25px">
                                                            <td width="20%" class="dvtCellLabel" align="right">日期时间</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                            <input type="text" name="lastname" tabindex="" class="detailedViewTextBox" style="width:50%;" value="2011-11-11" />                                                            </td>
                                                          ...
                                                          <tr style="height:25px">
                                                            ...
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                            <input type="text" name="lastname" tabindex="" class="detailedViewTextBox" style="width:50%;" value="送货错误" />                                                            </td>
                                                            <td width="20%" class="dvtCellLabel" align="right">原因及改进措施</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                            <input type="text" name="lastname" tabindex="" class="detailedViewTextBox" style="width:50%;" value="加强过程检验" />                                                            </td>
                                                          </tr>
...
<img src="../images/clear.gif" alt="清除" title="清除"   onclick="document.EditView.lastname2.value=''; document.EditView.lastname2.value='';"  align="absmiddle" style="cursor:hand;cursor:pointer" /></td>
                                                            ...
                                                            <td width="30%" align="left" class="dvtCellInfo">
<input type="text" name="lastname2" tabindex="" class="detailedViewTextBox" style="width:50%;" value="物料1" />
...
<img src="../images/clear.gif" alt="清除" title="清除" onclick="document.EditView.lastname2.value=''; document.EditView.lastname2.value='';"  align="absmiddle" style="cursor:hand;cursor:pointer" /></td>
                                                          ...
                                                          <tr style="height:25px">
                                                            ...
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                              <select name="select3"  style="width:52.5%">
                                                                <option value="0" selected="selected">请选状态</option>
                                                                <option value="1">1</option>
                                                            ...
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                              <select name="select3"  style="width:52.5%">
                                                                <option value="0" selected="selected">请选择是否严重质量事件</option>
