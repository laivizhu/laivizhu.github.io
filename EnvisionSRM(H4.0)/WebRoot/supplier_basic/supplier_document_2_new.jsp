...
<tbody><tr>
    <td style="padding-left:15px;" nowrap="nowrap">您现在的位置： 供应商日常管理 &gt; 供应商质量文档中心 &gt; 供应商实地考察报告 </td>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="width:15%" align="center" nowrap=""
															...
															onclick="fnLoadValues('bi','mi','basicTab','moreTab','normal','Contacts')">供应商实地考察报告</td>
...
<img src="../images/clear.gif" alt="清除" title="清除"   onclick="document.EditView.lastname2.value=''; document.EditView.lastname2.value='';"  align="absmiddle" style="cursor:hand;cursor:pointer" /></td>
                                                            ...
                                                            <td width="30%" align="left" class="dvtCellInfo"><input type="file" name="lastname2" tabindex="" class="detailedViewTextBox" style="width:72%;" value="" /></td>
                                                          </tr>
                                                          
                                                          <tr style="height:25px">
                                                            <td width="20%" class="dvtCellLabel" align="right">上传日期</td>
                                                            <td width="30%" align="left" class="dvtCellInfo"><input type="text" name="lastname4" tabindex="" class="detailedViewTextBox" style="width:50%;" value="" /></td>
                                                            <td width="20%" class="dvtCellLabel" align="right">上传人</td>
                                                            <td width="30%" align="left" class="dvtCellInfo"><input type="text" name="lastname3" tabindex="" class="detailedViewTextBox" style="width:50%;" value="" /></td>
                                                          </tr>
