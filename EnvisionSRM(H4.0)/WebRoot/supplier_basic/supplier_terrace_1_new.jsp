...
<table border="0" cellpadding="0" width="100%" class="level2Bg">
  <tbody>
    <tr>
      ...
      <td class="level2SelTab" nowrap="nowrap"><a href="supplier_terrace.jsp">供应商质量管理平台</a> </td>
...
<tbody><tr>
    <td style="padding-left:15px;" nowrap="nowrap">您现在的位置： 供应商日常管理 &gt; 供应商质量管理平台 &gt; 供应商质量管理事件输入 </td>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="width:15%" align="center" nowrap=""
															...
															onclick="fnLoadValues('bi','mi','basicTab','moreTab','normal','Contacts')">供应商质量管理事件输入</td>
                                                ...
                                                <tbody>
                                                  <tr style="height:25px">
                                                    <td ><table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                        <tbody>
                                                          <tr>
                                                            <td colspan="4" class="detailedViewHeader"><b>新建质量管理事件</b></td>
                                                          </tr>
                                                          
                                                          <tr style="height:25px">
                                                            <td width="20%" class="dvtCellLabel" align="right">日期时间</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                            <input type="text" name="lastname" tabindex="" class="detailedViewTextBox" style="width:50%;" value="" />                                                            </td>
                                                            <td width="20%" class="dvtCellLabel" align="right">发现地点</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                            <input type="text" name="lastname" tabindex="" class="detailedViewTextBox" style="width:50%;" value="" />                                                            </td>
                                                          </tr>
                                                         
                                                          <tr style="height:25px">
                                                            <td width="20%" class="dvtCellLabel" align="right">问题描述</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                            <input type="text" name="lastname" tabindex="" class="detailedViewTextBox" style="width:50%;" value="" />                                                            </td>
                                                            <td width="20%" class="dvtCellLabel" align="right">原因及改进措施</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                            <input type="text" name="lastname" tabindex="" class="detailedViewTextBox" style="width:50%;" value="" />                                                            </td>
                                                          </tr>
                                                          ...
                                                          <tr style="height:25px">
                                                            ...
                                                            <td width="30%" align="left" class="dvtCellInfo">
<input type="text" id="supplierNameInputId2" name="supplierNameInputId" class="detailedViewTextBox" style="width:50%;" value="" />
...
<img src="../images/clear.gif" alt="清除" title="清除"   onclick="document.EditView.lastname2.value=''; document.EditView.lastname2.value='';"  align="absmiddle" style="cursor:hand;cursor:pointer" /></td>
                                                            <td width="20%" class="dvtCellLabel" align="right">部件名称</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
<input type="text" name="lastname2" tabindex="" class="detailedViewTextBox" style="width:50%;" value="" />
选择物料: <img tabindex="2" src="../images/select.gif" alt="选择" title="选择" onclick="suppliesChoose()" align="absmiddle" style="cursor:hand;cursor:pointer"/> 
<img src="../images/clear.gif" alt="清除" title="清除" onclick="document.EditView.lastname2.value=''; document.EditView.lastname2.value='';"  align="absmiddle" style="cursor:hand;cursor:pointer" /></td>
                                                          </tr>
                                                          
                                                          <tr style="height:25px">
                                                            <td width="20%" class="dvtCellLabel" align="right">缺陷分类</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                              <select name="select3"  style="width:52.5%">
                                                            ...
                                                            <td width="20%" class="dvtCellLabel" align="right">问题分类</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                              <select name="select3"  style="width:52.5%">
                                                                <option value="0" selected="selected">请选择...</option>
                                                                <option value="1">1</option>
                                                          ...
                                                          <tr style="height:25px">
                                                            <td width="20%" class="dvtCellLabel" align="right">当前状态</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                              <select name="select3"  style="width:52.5%">
                                                                <option value="0" selected="selected">请选择...</option>
                                                                <option value="1">1</option>
                                                            ...
                                                            <td width="20%" class="dvtCellLabel" align="right">是否严重质量事件</td>
                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                              <select name="select3"  style="width:52.5%">
                                                                <option value="0" selected="selected">请选择...</option>
                                                          ...
                                                          <tr style="height:25px">
                                                            <td width="20%" class="dvtCellLabel" align="right">附件上传</td>
                                                            <td width="30%" align="left" class="dvtCellInfo"><input type="file" name="lastname3" tabindex="" class="detailedViewTextBox" style="width:72%;" value="" /></td>
                                                            <td width="20%" class="dvtCellLabel" align="right">机型平台</td>
                                                            <td width="30%" align="left" class="dvtCellInfo"><select name="select"  style="width:52.5%">
                                                              <option value="0" selected="selected">请选择...</option>
                                                              <option value="1">是</option>
                                                              <option value="2">否</option>
                                                            </select></td>
                                                ...
                                                <tbody>
                                                  <tr style="height:25px">
                                                    <td ><table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                     ...
                                                     onclick="window.location.href('supplier_terrace.jsp')" 
