        ...
        <tr>
          <td>
            ...
            <!-- 上部分导航 -->
              ...
              <tbody>
                <tr>
                  <td height="22px;" width="38%" nowrap="nowrap" style="padding-right:10px"><input class="crmbutton small edit" type="button" value="新建报告" onclick="javascript:window.location.href='supplier_document_3_new.jsp'" style="width:80" />
                  </td>
              ...
              <table border="0" cellspacing="1" cellpadding="3" width="100%" class="lvt small">
                <tbody>
                  ...
                  <tr bgcolor="white"  id="row_116" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'">
                    ...
                    <td>2012-10-30</td>
                    <td>张晓东</td>
                    <td><a href="supplier_document_3_edit.jsp">编辑</a>&nbsp;|&nbsp;<a href="#">删除</a></td>
                  </tr>
            ...
            <table border="0" cellspacing="0" cellpadding="2" width="100%">
              <tbody>
                <tr>
                  ...
                  <input class="crmbutton small edit" type="button" value="新建报告" onclick="javascript:window.location.href='supplier_document_3_new.jsp'"  style="width:80" />
                  </td>
                  <td width="32%" align="center" nowrap="nowrap" class="small"> 
                  	共 1 页，<img src="../images/previous_disabled.gif" border="0" align="absmiddle" alt="上一页"/>
                 	&nbsp;当前第&nbsp;1&nbsp;页&nbsp; <img src="../images/next_disabled.gif" border="0" align="absmiddle" alt="下一页"/>
