        ...
        <tr>
          <td>
            ...
            <!-- 上部分导航 -->
              ...
              <tbody>
                <tr>
                  <td height="22px;" width="38%" nowrap="nowrap" style="padding-right:10px"><input class="crmbutton small edit" type="button" value="新建" onclick="javascript:window.location.href='supplier_terrace_1_new.jsp'" style="width:80" />
                  </td>
            ...
            <div class="calDIV" style="overflow:auto;">
              <table border="0" cellspacing="1" cellpadding="3" width="100%" class="lvt small">
                <tbody>
                  <tr>
                    <td width="10%" class="lvtCol">时间</td>
                    <td width="10%" class="lvtCol">供应商</td>
                    <td width="10%" class="lvtCol">部件</td>
                    <td width="5%" class="lvtCol">缺陷分类</td>
                    <td width="10%" class="lvtCol">发现地</td>
                    <td width="10%" class="lvtCol">问题描述</td>
                    <td width="10%" class="lvtCol">问题分类</td>
                    <td width="10%" class="lvtCol">原因及改进措施</td>
                    <td width="5%" class="lvtCol">状态</td>
                    <td width="10%" class="lvtCol">是否严重质量事件</td>
                  ...
                  <tr bgcolor="white"  id="row_116" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'">
                    ...
                    <td>进行中</td>
                    <td>否</td>
                    <td><a href="supplier_terrace_1_edit.jsp">编辑</a>&nbsp;|&nbsp;<a href="#">删除</a></td>
                  </tr>
                  <tr bgcolor="white"  id="row_116" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'">
                    <td height="19">2012-11-11</td>
                    <td>测试数据</td>
                    <td>导轨</td>
                    <td>一般</td>
                    <td>三铸机</td>
            ...
            <table border="0" cellspacing="0" cellpadding="2" width="100%">
              <tbody>
                <tr>
                  ...
                  <input class="crmbutton small edit" type="button" value="新建" onclick="javascript:window.location.href='supplier_terrace_1_new.jsp'"  style="width:80" />
                  </td>
                  <td width="32%" align="center" nowrap="nowrap" class="small"> 
                  	共 1 页，<img src="../images/previous_disabled.gif" border="0" align="absmiddle" alt="上一页"/>
                 	&nbsp;当前第&nbsp;1&nbsp;页&nbsp; <img src="../images/next_disabled.gif" border="0" align="absmiddle" alt="下一页"/>
