...
<head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script language="javascript" type="text/javascript" src="../js/material/material_common.js"></script>
  	<script language="javascript" type="text/javascript" src="../js/supplier/supplier_update.js"></script>
<style type="text/css">
<!--
...
<td style="width:15%" align="center" class="dvtSelectedCell" id="bi" onclick="fnLoadValues('bi','mi','basicTab','moreTab','normal','Contacts')">修改供应商信息</td>
...
<input type="hidden" name="supplierBasic.id" id='idFormFieldId' />
      ...
      <tbody>
        <tr>
                                ...
                                <tr style="height:25px">
                                  ...
                                  <td width="25%" colspan="3" align="left" class="dvtCellInfo"><input id="nameFormFieldId" name="supplierBasic.name" type="text"  /></td>
                                  <td width="25%" colspan="2" align="right" class="dvtCellLabel">采购部门申请人</td>
                                  <td width="25%" colspan="3" align="left" class="dvtCellInfo"><input type="text" tabindex="" class="detailedViewTextBox" style="width:70%;" id="userNameInputId" />
          	<img tabindex="2" src="../images/select.gif" alt="选择" title="选择" onclick="userChoose()" align="absmiddle" style="cursor:hand;cursor:pointer"/>
            <img src="../images/clear.gif" alt="清除" title="清除"   onclick="cleanUser()"  align="absmiddle" style="cursor:hand;cursor:pointer" /></td>
                                  
                                </tr>
                                <tr style="height:25px">
                                	<td colspan="2" class="dvtCellLabel" align="right">是否生产性物料</td>
                                 	<td colspan="3" align="left" class="dvtCellInfo"><input type="radio" id='"productivityMaterialFormFieldId"' value="true" name="supplierBasic.productivityMaterial">是 <input type="radio" value="false" name="supplierBasic.productivityMaterial">否</td>
                                  <td colspan="2"class="dvtCellLabel" align="right">负责人姓名</td>
                                  <td colspan="3" align="left" class="dvtCellInfo"><input id="personNameFormFieldId" name="supplierBasic.personName" type="text"  /></td>
                                  
                                </tr>
                                <tr style="height:25px">
                                <td colspan="2" align="right" class="dvtCellLabel">负责人手机号</td>
                                  <td colspan="3" align="left" class="dvtCellInfo"><input id="phoneFormFieldId" name="supplierBasic.phone" type="text"  /></td>
                                  <td colspan="2" class="dvtCellLabel" align="right">负责人Email</td>
                                  <td colspan="3" align="left" class="dvtCellInfo"><input id="emailFormFieldId" name="supplierBasic.email" type="text"  /></td>
                                </tr>
                                <tr style="height:25px">
                                  <td colspan="2" class="dvtCellLabel" align="right">物料分类</td>
                                  <td colspan="3" align="left" class="dvtCellInfo">
                                  <select  style="width:93%;" id="materialClassifyId"></select>
                                  </td>
                                  <td colspan="2" align="right" class="dvtCellLabel">物料类别</td>
                                  <td colspan="3" align="left" class="dvtCellInfo">
                                  	<select style= "width:93%;" id="materialCategoryId"> </select>
                                  </td>
                                </tr>
                                <tr style="height:25px">
                                 <td colspan="2" class="dvtCellLabel" align="right">物料子类别</td>
                                 <td colspan="8" align="left" class="dvtCellInfo">
                                 <select name="subCategoryId" id="materialSubCategoryId" style= "width:30%;"> </select>
            					</td>
                                </tr>
                           </tbody></table>
                           <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
