...
<div id="div1" class="small" style="width:100%;position:relative;">
  <form name="contractConfirm" action="" >
              ...
              <tbody>
                <tr>
                  <td width="38%" nowrap="nowrap" style="padding-right:10px"><span class="calDIV" style="overflow:auto;">
                    <input class="crmbutton small edit" type="button" value="选择" onclick="show1();" style="width:80" />
                  </span></td>
              ...
              <table border="0" cellspacing="1" cellpadding="3" width="100%" class="lvt small">
                <tbody>
                    <tr>
                      ...
                      <td width="27%" align="left" class="lvtCol">小组名称</td>
                      <td width="30%" align="left" class="lvtCol">所属类别</td>
              ...
              <tbody>
                <tr>
                  <td width="38%" nowrap="nowrap" style="padding-right:10px">
                   <input class="crmbutton small edit" type="button" value="选择" onclick="show1();" style="width:80"/></td>
                  <td width="32%" align="center" nowrap="nowrap" class="small"> 
                  	共 1 页，<img src="../images/previous_disabled.gif" border="0" align="absmiddle" alt="上一页"/>&nbsp;当前第&nbsp;1&nbsp;页&nbsp;<img src="../images/next_disabled.gif" border="0" align="absmiddle" alt="下一页"/></td>
                  <td width="30%" align="right" class="small" style="padding-right:20px">每页显示 10 条记录</td>
                  <!-- Page Navigation -->
    ...
    <div style="margin-top:223px;"></div>
</div>
