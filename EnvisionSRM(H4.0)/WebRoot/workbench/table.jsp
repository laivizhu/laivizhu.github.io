		...
		$(document).ready(
			function(){
				var table = new HouQianTable({
					...
					columns:[
						{name:"categoryType",width:"52%",bindingProperty:"categoryType"},
						{name:"类别名",width:"10%",bindingProperty:"name"},
						{name:"parent",width:"10%",bindingProperty:"parent"},
						{name:"islock",width:"10%",bindingProperty:"islock"}
