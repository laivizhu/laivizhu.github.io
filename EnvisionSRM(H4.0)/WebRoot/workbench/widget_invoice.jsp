...
<table width="100%" cellpadding="0" cellspacing="0" class="widgetHandle">
  <tbody><tr>
	<td width="70%" nowrap="nowarp" class="widgetHandleTitle">发票信息</td>
...
<table width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td class="widget_content_title">发票号码</td>
	<td class="widget_content_title" width="60px">剩余时间</td>
  </tr>
  <div id="content">
  <tr>
    <td class="widgetContentDetail"><a href="#" title="">300001</a></td>
    <td class="widgetContentDetail">0天 </td>
  </tr>
  <tr>
    <td  class="widgetContentDetail"> <a href="#" title="">300002</a></td>
