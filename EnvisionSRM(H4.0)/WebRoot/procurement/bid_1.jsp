        ...
        <tr>
          <td>
            ...
            <!-- 上部分导航 -->
              ...
              <tbody>
                <tr>
                  <td height="22px;" width="38%" nowrap="nowrap" style="padding-right:10px"><input class="crmbutton small edit" type="button" value="新建" onclick="javascript:window.location.href='bid_1_new.jsp'"  style="width:80" />
                  </td>
              ...
              <table border="0" cellspacing="1" cellpadding="3" width="100%" class="lvt small">
                <tbody>
                  <tr>
                    ...
                    <td width="20%" class="lvtCol">历史年度招标项目</td>
                    <td width="10%" class="lvtCol">发起人</td>
                    <td width="20%" class="lvtCol">招标项目状态</td>
                    <td width="20%" class="lvtCol">物料名称</td>
                  ...
                  <tr bgcolor="white"  id="row_116" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'">
                    <td height="19">20112311</td>
                    <td>厚谦咨询</td>
                    <td>采购员A</td>
                    <td>已完成</td>
                    <td>风机叶</td>
                    <td>2011-10-10</td>
                    <td><a href="bid_1_check.jsp">查看</a></td>
                  </tr>
                  <tr bgcolor="white"  id="row_116" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'">
                    <td height="19">20120214</td>
                    <td>测试数据A</td>
                    <td>采购员B</td>
                    <td>已完成</td>
                    <td>已完成</td>
            ...
            <table border="0" cellspacing="0" cellpadding="2" width="100%">
              <tbody>
                <tr>
                  ...
                  <input class="crmbutton small edit" type="button" value="新建" onclick="javascript:window.location.href='bid_1_new.jsp'"  style="width:80" />
                  </td>
                  <td width="32%" align="center" nowrap="nowrap" class="small"> 
                  	共 1 页，<img src="../images/previous_disabled.gif" border="0" align="absmiddle" alt="上一页"/>
                 	&nbsp;当前第&nbsp;1&nbsp;页&nbsp; <img src="../images/next_disabled.gif" border="0" align="absmiddle" alt="下一页"/>
