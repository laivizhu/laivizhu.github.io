                ...
                <table border="0" cellspacing="1" cellpadding="3" width="100%" class="lvt small">
                  <tbody>
                    <tr>
                      ...
                      <td width="20%"class="lvtCol">招标项目名称</td>
                      <td width="10%" class="lvtCol">发起人</td>
                      <td width="15%"class="lvtCol">招标状态</td>
                      <td width="15%"class="lvtCol">已确认投标供应商比例</td>
                      <td width="10%" class="lvtCol">招标开始时间</td>
                    ...
                    <tr bgcolor="white"  id="row_116" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'">
                      ...
                      <td>2012-10-22</td>
                      <td>2012-10-20</td>
                      <td><a href="bid_3_check.jsp">查看</a></td>
                    </tr>
                    <tr bgcolor="white"  id="row_116" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'">
                      <td height="19">20120219</td>
                      <td>测试数据Y</td>
                      <td>采购员A</td>
                      <td>待确认标书</td>
                      <td>4/5</td>
