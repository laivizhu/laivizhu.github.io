      ...
      <tbody>
        ...
        <tr>
          <td height="40px;" colspan="10" style="padding:5px"><div align="center">
              <input title="通过 [Alt+S]" accesskey="S" class="crmbutton small save" onclick="firstPass()" type="button" name="button" value="  通过  " style="width:70px" />&nbsp;
              <input title="驳回 [Alt+X]" accesskey="X" class="crmbutton small cancel" onclick="reject()" type="button" name="button" value="  驳回 " style="width:70px" />&nbsp;
...
<div id="rejectDivId" style="margin:0;display:none;">
<br />
 <form id="rejectFormId" method="post" action="">
 	<table width="100%" align="center" border="0" cellpadding="3" cellspacing="0" class="table_border">
      <tr>
        <td align="center" valign="middle" class="td_border">驳回原因</td>
     </tr>
     <tr>
        ...
        <td colspan="2" align="center" height="40">
          <input class="crmbutton small save" type="submit" value="发送" style="width:70px"/>&nbsp;
