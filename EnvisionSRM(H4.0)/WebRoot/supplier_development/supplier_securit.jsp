                            ...
                            <tbody>
                              <tr>
                                <td style="padding: 10px;">
                                  <jsp:include page="supplier_securit_1.jsp" flush="true"/>
                                  <jsp:include page="supplier_securit_2.jsp" flush="true"/>
                                  <jsp:include page="supplier_securit_3.jsp" flush="true"/>
                                  <jsp:include page="supplier_securit_4.jsp" flush="true"/>
                                </td>
                              </tr>
                            </tbody>
                          </table></td>
