...
<!--
	...
	var supplierTable=new HouQianTable({
		url:"supplierBasic_list.action?status=0",
		...
		specialOperations:[
			{name:"初审",isAjax:true,callback:function(data){
					if(houQian.isNotNull(data)){
						window.location.href="supplier_set_2_review.jsp?id="+data.id+getRandParam();
					}
				}
			}	
		],
...
<div id="suppliersTableId" class="small" style="width:100%;position:relative;">
</div>
