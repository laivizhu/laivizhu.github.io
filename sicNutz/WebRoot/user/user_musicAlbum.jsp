  ...
  <body>
		    ...
		    <div class="span9">
		    	...
		    	<div style="position: fixed; float: right;width:100px;height:60px; right:10px;" >
		    		<ul class="nav nav-pills">
						      <li>
						        <a href="album_add.jsp" class="btn"><i class='icon-music'></i>创建专辑</a>
						      </li>
					    </ul>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(sic.basic.init(function(){
			...
			sic.pageLoding.scrollBreakPage('../media/album/albumList.nut?album.type=MUSIC', $("#albumListDivId"), function(item){
				return "<div class='span4'><div class='thumbnail'><a href='fm_music.html?id="+item.id+"' target='blank'><img src='../images/default/musicAlbum.jpg'></a><div class='caption'><p>"+item.name+"</p><p>"+item.description+"</p><p><a class='btn' href='#' onclick=deleteObject('../media/album/delete.nut?id="+item.id+"')><i class='icon-remove-circle'></i>删除</a>&nbsp;<a class='btn' href='album_add.jsp?id="+item.id+"'><i class='icon-edit'></i>编辑</a></p></div></div></div>";
			});
		}));
