  ...
  <jsp:include page="../common/navigate.jsp"/>
						...
						<div class='tab-content'>
							<div class='tab-pane fade in active' id='person'>
								<div class="row" >
									...
									<div class="span8" id="personListDivId">
									</div>
								</div>
								<hr>
							</div>
	...
	<script type="text/javascript">
		$(document).ready(sic.basic.init(function(){
			...
			sic.common.submitForm($("#autoGraphAddFormId"),'../common/autograph/add.nut',function(){
				window.location.reload();
			},false,false);
			
			sic.pageLoding.pageLoad('../common/autograph/listFriendAutoGraph.nut', $("#friendsListDivId"), function(item){
				return "<div class='span8'><p>"+item.content+"</p><p><div align='right'>"+item.createDate+"|"+item.user.name+"</div></p></div>";
			});
			
			sic.pageLoding.pageLoad('../common/autograph/list.nut?fold=true',$("#personListDivId"), function(item){
				return "<div class='span8'><p>"+item.content+"</p><p><div align='right'>"+item.createDate+"|<a class='btn' onclick=deleteObject('../common/autoGraph/delete.nut?id="+item.id+"')><i class='icon-remove-circle'></i>删除</a></div></p></div>";
			});
		}));
	</script>
  </body>
