  ...
  <body>
	...
	<script type="text/javascript">
		$(document).ready(sic.basic.init(function(){
			...
			sic.pageLoding.pageLoad('../media/book/listBook.nut?book.createIs=false', $("#bookListDivId"), function(item){
			...
			sic.pageLoding.pageLoad('../media/book/listBook.nut?book.createIs=true', $("#myCreateBookListDivId"), function(item){
				return "<div class='span4'><div class='thumbnail'><a href='user_viewBook.jsp?id="+item.id+"'><img src='../images/default/musicAlbum.jpg'></a><div class='caption'><p>"+item.name+"</p><p>"+item.description+"</p><p><a class='btn' href='#' onclick=deleteObject('../media/book/delete.nut?id="+item.id+"')><i class='icon-remove-circle'></i>删除</a>&nbsp;<a class='btn' href='user_addBook.jsp?id="+item.id+"'><i class='icon-edit'></i>编辑</a><a class='btn' href='../media/book/download.nut?id="+item.id+"' class='btn btn-primary'><i class='icon-download'></i>下载</a></p></div></div></div>";
			});
