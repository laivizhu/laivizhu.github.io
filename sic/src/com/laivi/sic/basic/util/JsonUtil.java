...
import com.laivi.sic.basic.model.po.IBasicJsonEntity;
...
public final class JsonUtil {
	...
	private static class JsonEntityProcessor implements JsonValueProcessor {
		...
		private Object process(Object value) {
			return ((IBasicJsonEntity) value).toJson();
		}
	}
	...
	static {
		...
		JSON_CONFIG.registerJsonValueProcessor(IBasicJsonEntity.class, new JsonEntityProcessor());
	}
